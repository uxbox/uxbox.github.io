...
var or__18137__auto__ = cljs.test._STAR_current_env_STAR_;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__19177__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26169){
var G__26170 = cljs.core.first.call(null,seq26169);
var seq26169__$1 = cljs.core.next.call(null,seq26169);
var G__26171 = cljs.core.first.call(null,seq26169__$1);
var seq26169__$2 = cljs.core.next.call(null,seq26169__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__26170,G__26171,seq26169__$2);
});
...
var map__26174 = m;
var map__26174__$1 = ((cljs.core.seq_QMARK_.call(null,map__26174))?cljs.core.apply.call(null,cljs.core.hash_map,map__26174):map__26174);
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26174,map__26174__$1,file,line,column){
return (function (p1__26172_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26172_SHARP_));
});})(map__26174,map__26174__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__19032__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__19032__auto__,prefer_table__19033__auto__,method_cache__19034__auto__,cached_hierarchy__19035__auto__,hierarchy__19036__auto__){
return (function (m){
...
var temp__4425__auto___26175 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___26175)){
var message_26176 = temp__4425__auto___26175;
cljs.core.println.call(null,message_26176);
} else {
}
...
var temp__4425__auto___26177 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___26177)){
var message_26178 = temp__4425__auto___26177;
cljs.core.println.call(null,message_26178);
} else {
}
...
var temp__4423__auto__ = (function (){var and__18125__auto__ = typeof exception.stack === 'string';
if(and__18125__auto__){
var G__26184 = exception.stack;
var G__26184__$1 = (((G__26184 == null))?null:clojure.string.split_lines.call(null,G__26184));
var G__26184__$2 = (((G__26184__$1 == null))?null:cljs.core.get.call(null,G__26184__$1,depth));
var G__26184__$3 = (((G__26184__$2 == null))?null:clojure.string.trim.call(null,G__26184__$2));
return G__26184__$3;
} else {
...
var vec__26185 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26185,(0),null);
var column = cljs.core.nth.call(null,vec__26185,(1),null);
var vec__26186 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26186,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26186,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26186,(2),null);
...
var m__$1 = (function (){var G__26188 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__26188) {
case "fail":
 ...
 * testing.
 */
cljs.test.IAsyncTest = (function (){var obj26191 = {};
return obj26191;
})();
...
return G__26193.cljs$test$IAsyncTest$;
}
})())){
return true;
} else {
if((!G__26193.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.test.IAsyncTest,G__26193);
} else {
return false;
}
}
...
var G__26196 = (function (){var G__26195 = cljs.core.rest.call(null,fns);
var G__26195__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__26195):G__26195);
return G__26195__$1;
})();
fns = G__26196;
continue;
...
var G__26198 = fns;
var G__26198__$1 = (((G__26198 == null))?null:cljs.core.vary_meta.call(null,G__26198,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__26198__$1;
});
...
var G__26202 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__26202) {
...
var vec__26205 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26205,(0),null);
var types = vec__26205;
...
return cljs.core.map.call(null,(function (p__26213){
var vec__26214 = p__26213;
var ns = cljs.core.nth.call(null,vec__26214,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26214,(1),null);
return ((function (vec__26214,ns,vars__$1){
return (function (){
...
var G__26215 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__26215) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1){
return (function (){
var seq__26216 = cljs.core.seq.call(null,vars__$1);
var chunk__26217 = null;
var count__26218 = (0);
var i__26219 = (0);
while(true){
if((i__26219 < count__26218)){
var v = cljs.core._nth.call(null,chunk__26217,i__26219);
var temp__4425__auto___26221 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___26221)){
var t_26222 = temp__4425__auto___26221;
each_fixture_fn.call(null,((function (seq__26216,chunk__26217,count__26218,i__26219,t_26222,temp__4425__auto___26221,v,each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26222)));
});})(seq__26216,chunk__26217,count__26218,i__26219,t_26222,temp__4425__auto___26221,v,each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1))
);
} else {
}

var G__26223 = seq__26216;
var G__26224 = chunk__26217;
var G__26225 = count__26218;
var G__26226 = (i__26219 + (1));
seq__26216 = G__26223;
chunk__26217 = G__26224;
count__26218 = G__26225;
i__26219 = G__26226;
continue;
} else {
...
var c__18922__auto__ = cljs.core.chunk_first.call(null,seq__26216__$1);
var G__26227 = cljs.core.chunk_rest.call(null,seq__26216__$1);
var G__26228 = c__18922__auto__;
var G__26229 = cljs.core.count.call(null,c__18922__auto__);
var G__26230 = (0);
seq__26216 = G__26227;
chunk__26217 = G__26228;
count__26218 = G__26229;
i__26219 = G__26230;
continue;
} else {
var v = cljs.core.first.call(null,seq__26216__$1);
var temp__4425__auto___26231__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___26231__$1)){
var t_26232 = temp__4425__auto___26231__$1;
each_fixture_fn.call(null,((function (seq__26216,chunk__26217,count__26218,i__26219,t_26232,temp__4425__auto___26231__$1,v,seq__26216__$1,temp__4425__auto__,each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26232)));
});})(seq__26216,chunk__26217,count__26218,i__26219,t_26232,temp__4425__auto___26231__$1,v,seq__26216__$1,temp__4425__auto__,each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1))
);
} else {
}
...
});})(each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1))
);
});})(each_fixture_fn,G__26215,env,once_fixtures,each_fixtures,vec__26214,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1437028484142